#This script allows us to modify the GPO of "Remove Change Password"

#Define Registry Key & Path
$RegPath = 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Policies'
$RegKey = 'System'
$RegParam = 'DisableChangePassword'
...
Write-Output 'Successfully Blocked Remove Change Password GPO'