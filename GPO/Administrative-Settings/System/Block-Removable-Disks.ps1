#This script allows us to modify GPO of Removable Disks Deny R/W/X for User & Machine
...
$RegKey = '{53f5630d-b6bf-11d0-94f2-00a0c91efb8b}'
...
Write-Host 'Completed Blocking Removable Disks R/W/X'