#This script allows us to modify the GPO of "Block All Consumer Microsoft Account User Authentication"

#Define Registry Key & Path
$RegPath = 'HKLM:\Software\Policies\Microsoft'
$RegKey = 'MicrosoftAccount'
$RegParam = 'DisableUserAuth'
...
Write-Output 'Successfully Blocked All Consumer Microsoft Account User Authentication'