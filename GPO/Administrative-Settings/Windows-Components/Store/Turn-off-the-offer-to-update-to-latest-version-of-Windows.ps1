#This script allows us to modify GPO of Turn off the Offer to Update to the Latest Version of Windows
...
Write-Host 'Completed Enabling the GPO of "Turn Off the Offer to Update to the Latest Version of Windows"'